...
const Expenses = ({ navigation, route }) => {
  ...
  const handleUpdateExpense = async () => {
    ...
    if (!normalizedTotalBudgetExpense || isNaN(normalizedTotalBudgetExpense) || normalizedTotalBudgetExpense <= 0) {
      alert("Please, enter a valid expense total budget limit.");
      return;
    }

    console.log("Attempting to update expense with:", {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.transactionsContainer}>
        ...
        <KeyboardAwareFlatList
          ...
          ListEmptyComponent={<Text style={{ marginVertical: "2%", marginLeft: "6%" }}>No transactions found.</Text>}
          ListFooterComponent={
